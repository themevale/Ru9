...
(function () {
      ...
      el.querySelectorAll(selectors.trigger).forEach(trigger => {
        ...
        if (trigger.closest('.filter-form') && window.innerWidth >= 960) {
          ...
          trigger.addEventListener('click', (e) => {
            trigger.parentElement.querySelector(selectors.module).classList.add(classes.open);
          })
  ...
  theme.Drawers = (function () {
    ...
    Drawers.prototype = Object.assign({}, Drawers.prototype, {
      init: function () {
        ...
        if (document.querySelector('.js-drawer-open-collection-filters')) {
          document.querySelector('.js-drawer-open-collection-filters').addEventListener('click', () => {
            document.querySelectorAll('#FilterDrawer .collapsible-content--sidebar').forEach(item => {
  ...
  class StickyNavigation extends HTMLElement {
    constructor() {
      ...
      this.linkWrap = this.querySelector('.sticky-navigation__links')
    ...
    renderLink() {
      const divs = document.querySelectorAll('[data-anchor-link="true"]');
      ...
      divs.forEach(div => {
        ...
        if (text) {
          ...
          this.linkWrap.appendChild(a);
        }
      });
    }
  }

  customElements.define('sticky-navigation', StickyNavigation);
  ...
  //       this.other = Array.from(this.closest('[id^=ProductSection-]').querySelectorAll('variant-radios')).filter((selector) => {
  //         return selector != this;
  //       });
  //     } else {
  //       this.other = Array.from(this.closest('[id^=ProductSection-]').querySelectorAll('variant-selects')).filter((selector) => {
  //         return selector != this;
  //       });
  //     }
  ...
  //           alterOptions[0].querySelector('sticky-add-to-cart [data-selected-value]').textContent = selectedOption1;
  //         }
  ...
  //           alterOptions[1].querySelector('sticky-add-to-cart [data-selected-value]').textContent = selectedOption2;
  //         }
  ...
  //           alterOptions[2].querySelector('sticky-add-to-cart [data-selected-value]').textContent = selectedOption3;
  //         }
  //       }
  //     }
  //   }
  ...
  //   updateVariantInput() {
  //     const productForms = document.querySelectorAll(`#product-form-${this.dataset.section}, #AddToCartForm-${this.dataset.section}-${this.dataset.productId}-duplicate, #product-form-installment-${this.dataset.section}`);
  ...
  //   getVariantData() {
  //     this.variantData = this.variantData || JSON.parse(this.querySelector('[type="applicate/json"]').textContent);
  ...
  class ProductBundleItem extends HTMLElement {
    ...
    updateOptions() {
      ...
      this.options = [...radioOption, ...selectOption];
    }
  ...
  theme.Collection = (function () {
    ...
    Collection.prototype = Object.assign({}, Collection.prototype, {
      ...
      initSort: function () {
        ...
        this.sortSelectMobile = document.querySelector(selectors.sortSelectMobile);

        if (this.sortSelectMobile) {
          this.defaultSortMobile = this.getDefaultSortMobileValue();
          this.sortSelectMobile.on('change' + this.namespace, this.onSortMobileChange.bind(this));
        }
      },
      ...
      getDefaultSortMobileValue: function () {
      ...
      onSortMobileChange: function () {
        this.queryParams = new URLSearchParams(window.location.search);

        this.queryParams.set('sort_by', this.getSortMobileValue());
        this.queryParams.delete('page'); // Delete if it exists
      ...
      tagClick: function (evt) {
        ...
        el.matches(selectors.facetClear) ? history.pushState({}, "", newUrl) : this.renderActiveTag(parent, el);
        ...
        detailsEl.forEach((detail) => {
          ...
          detail.addEventListener('focusin', () => {
            if (!detail.hasAttribute('open')) {
              ...
              document.documentElement.classList.add('js-header-details-hover')
            }
          });
          ...
          detail.addEventListener('focusout', () => {
            if (detail.hasAttribute('open') && !detail.matches(':focus-within')) {
              detail.removeAttribute('open');
              detail.setAttribute('aria-expanded', 'false');
              document.documentElement.classList.remove('js-header-details-hover')
            }
          });
  ...
  theme.ProductSection = (function () {
    ...
    Product.prototype = Object.assign({}, Product.prototype, {
      ...
      initAjaxProductForm: function () {
        setTimeout(() => {
          this.container.querySelectorAll('.product-single__form').forEach(form => {
  ...
  theme.MasonrySection = (function () {
    ...
    MasonrySection.prototype = Object.assign({}, MasonrySection.prototype, {
      init: function () {
        var slides = this.slideshow.querySelectorAll('.masonry-item');
  ...
  theme.CollectionTabSection = (function () {
    ...
    CollectionTabSection.prototype = Object.assign({}, CollectionTabSection.prototype, {
      init: function () {
  ...
  theme.BannerWithCollectionSection = (function () {
    ...
    function BannerWithCollectionSection(container) {
      this.container = container;
      var sectionId = container.getAttribute('data-section-id');
      this.slideshow = container.querySelector('#Banner-Collection-' + sectionId);
      this.namespace = '.' + sectionId;
    ...
    BannerWithCollectionSection.prototype = Object.assign({}, BannerWithCollectionSection.prototype, {
      init: function () {
  ...
  theme.CertificationSection = (function () {
    ...
    CertificationSection.prototype = Object.assign({}, CertificationSection.prototype, {
      init: function () {
  ...
  theme.CompareSection = (function () {

    function CompareSection(container) {
      this.container = container;
      var sectionId = container.getAttribute('data-section-id');
      this.slideshow = container.querySelector('#Compare-Products-' + sectionId);
      this.namespace = '.' + sectionId;
    ...
    CompareSection.prototype = Object.assign({}, CompareSection.prototype, {
      init: function () {
        var slides = this.slideshow.querySelectorAll('.grid__item');
  ...
  theme.ProdcutCarouselModal = (function () {
    function ProdcutCarouselModal(container) {
      this.container = container;
      var sectionId = container.getAttribute('data-block-id');
      this.slideshow = container.querySelector('#ModalCarousel-' + sectionId);
      this.namespace = '.' + sectionId;
    ...
    ProdcutCarouselModal.prototype = Object.assign({}, ProdcutCarouselModal.prototype, {
      init: function () {
        var slides = this.slideshow.querySelectorAll('.carousel-item');
  ...
  DOMready(function () {
    ...
    theme.sections.register('product_section', theme.ProductSection);
    ...
    theme.sections.register('banner-w-coll-section', theme.BannerWithCollectionSection);
    theme.sections.register('blogposts-section', theme.BlogPostSection);
    theme.sections.register('certification-section', theme.CertificationSection);
    theme.sections.register('compare-products', theme.CompareSection);
